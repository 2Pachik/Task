...
void JSONReader(string makaka, boost::property_tree::ptree& root) {

	for (boost::property_tree::ptree::value_type& disk : root.get_child(makaka)) {

		string name = disk.first;
		string height = disk.second.data();
